...
VREG_CONSUMERS(L8) = {
	...
	REGULATOR_SUPPLY("cam_vana3",	"4-0078"),
#endif
};
VREG_CONSUMERS(L9) = {
...
VREG_CONSUMERS(L17) = {
	...
	REGULATOR_SUPPLY("cyttsp4_vdda",	"spi_qsd.9"),	
...
#if defined(CONFIG_WEBCAM_OV7692)
	REGULATOR_SUPPLY("cam_vio2",	"4-0078"),
#endif
};
VREG_CONSUMERS(LVS7) = {
...
VREG_CONSUMERS(EXT_5V) = {
	...
	REGULATOR_SUPPLY("vbus_shswic",		"msm_shswic.0"),
#endif /* CONFIG_USB_SWIC */
#ifdef CONFIG_USB_MSM_OTG_SH_CUST_MHL
	REGULATOR_SUPPLY("vbus_shusb_mhl",		"msm_otg"),
...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L10,	 0, 1, 0, 3000000, 3000000, NULL,      0, 0),
	RPM_LDO(L11,	 0, 1, 0, 2850000, 2850000, NULL,      0, 0),
	RPM_LDO(L12,	 0, 1, 0, 1250000, 1250000, "8921_s4", 0, 0),
	RPM_LDO(L14,	 0, 1, 0, 1800000, 1800000, NULL,      0, 0),
	RPM_LDO(L15,	 0, 1, 0, 1800000, 3100000, NULL,      0, 0),
	RPM_LDO(L16,	 0, 1, 0, 3000000, 3000000, NULL,      0, 0),
#if defined( CONFIG_SHTPS_SY3X00_DEV ) || defined( CONFIG_SHTPS_TMA4XX_DEV )
	RPM_LDO(L17,	 1, 1, 0, 3000000, 3000000, NULL,      0, 0),
#else
	RPM_LDO(L17,	 0, 1, 0, 1800000, 2950000, NULL,      0, 0),
#endif	/* CONFIG_SHTPS_SY3X00_DEV || CONFIG_SHTPS_TMA4XX_DEV */
...
#ifdef CONFIG_BATTERY_SH
void __init msm8960_pm8921_regulator_init(void)
{
#ifdef CONFIG_PM_REG_L8_ON
	...
	if ((rev == 0x00000000/*SH_HW_REV_ES0*/) ||
		...
		for (idx = 0; idx < ARRAY_SIZE(msm_rpm_regulator_init_data); idx++) {
			if (msm_rpm_regulator_init_data[idx].id == RPM_VREG_ID_PM8921_L8) {
				msm_rpm_regulator_init_data[idx].init_data.constraints.always_on = 1;
				break;
			}
		}
	}
