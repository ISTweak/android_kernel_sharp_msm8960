 ...
 *****************************************************************************/
#ifdef CONFIG_SHSYS_CUST
static int sh_pm_idle_pc_flg = 0;

void sh_pm_set_idle_pc_flg_on(void)
{
	sh_pm_idle_pc_flg = 1;
}

void sh_pm_set_idle_pc_flg_off(void)
{
	sh_pm_idle_pc_flg = 0;
}

int sh_pm_is_idle_pc(void)
{
	return sh_pm_idle_pc_flg;
}
#endif
