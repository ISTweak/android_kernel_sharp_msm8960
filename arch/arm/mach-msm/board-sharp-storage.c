...
#if defined(CONFIG_MACH_LYNX_DL15) && defined(CONFIG_MMC_SD_CUST_SH)
#include <sharp/sh_boot_manager.h>
#define SH_REV_SDC_ES0	0x0
#define SH_REV_SDC_ES1	0x5
#define SH_REV_SDC_ES15	0x1
#define SH_REV_SDC_PP1	0x6
#define SH_REV_SDC_PP15	0x3
#define SH_REV_SDC_PP2	0x7
#endif
...
#ifndef CONFIG_MMC_EMMC_CUST_SH
	{TLMM_HDRV_SDC1_CLK, GPIO_CFG_16MA},
	{TLMM_HDRV_SDC1_CMD, GPIO_CFG_10MA},
	{TLMM_HDRV_SDC1_DATA, GPIO_CFG_10MA}
#else /* CONFIG_MMC_EMMC_CUST_SH */
	{TLMM_HDRV_SDC1_CLK, GPIO_CFG_8MA},
	{TLMM_HDRV_SDC1_CMD, GPIO_CFG_4MA},
	{TLMM_HDRV_SDC1_DATA, GPIO_CFG_4MA}
...
static struct msm_mmc_pad_drv sdc3_pad_drv_on_cfg[] = {
	...
	{TLMM_HDRV_SDC3_CLK, GPIO_CFG_6MA},	/* 010 */
	{TLMM_HDRV_SDC3_CMD, GPIO_CFG_6MA},	/* 010 */
	{TLMM_HDRV_SDC3_DATA, GPIO_CFG_6MA}	/* 010 */
#endif /* CONFIG_MMC_SD_CUST_SH */
};

#if defined(CONFIG_MACH_LYNX_DL15) && defined(CONFIG_MMC_SD_CUST_SH)
static struct msm_mmc_pad_drv sdc3_pad_drv_on_PP2_cfg[] = {
...
static struct msm_mmc_pad_pull sdc3_pad_pull_off_cfg[] = {
	...
	{TLMM_PULL_SDC3_DATA, GPIO_CFG_PULL_UP}
#else /* CONFIG_MMC_SD_CUST_SH */
	{TLMM_PULL_SDC3_CMD, GPIO_CFG_KEEPER},
	{TLMM_PULL_SDC3_DATA, GPIO_CFG_KEEPER}
#endif /* CONFIG_MMC_SD_CUST_SH */
};
...
static unsigned int sdc3_sup_clk_rates[] = {
	400000, 20000000, 24000000, 48000000, 96000000, 192000000
};
#else /* CONFIG_USE_FREYJA_CUST_SH */
static unsigned int sdc3_sup_clk_rates[] = {
...
void __init msm8960_init_mmc(void)
{
	...
	if(rev == SH_REV_SDC_PP2) {
		msm8960_sdc3_data.pin_data->pad_data->drv->on = sdc3_pad_drv_on_PP2_cfg;
		msm8960_sdc3_data.pin_data->pad_data->drv->size = ARRAY_SIZE(sdc3_pad_drv_on_PP2_cfg);
	}
#endif
#ifdef CONFIG_MMC_MSM_SDC1_SUPPORT
	/*
