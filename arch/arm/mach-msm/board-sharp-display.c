...
/* 720(736) x 1280 x 4(bpp) x 3(pages) */
#define MSM_FB_PRIM_BUF_SIZE \
		(roundup((736 * 1280 * 4), 4096) * 3) /* 4 bpp x 3 pages */
#else
/* 720(736) x 1280 x 4(bpp) x 2(pages) */
#define MSM_FB_PRIM_BUF_SIZE \
		(roundup((736 * 1280 * 4), 4096) * 2) /* 4 bpp x 2 pages */
#endif
...
#ifdef CONFIG_SHLCDC_BOARD
#if defined(CONFIG_MACH_LYNX_DL10) || defined(CONFIG_MACH_BLT) || defined(CONFIG_MACH_DECKARD_AS38)
#define MSM_FB_SIZE roundup(0x1086000, 4096)
#elif defined(CONFIG_MACH_LYNX_DL15) || defined(CONFIG_MACH_LYNX_DL18)
#define MSM_FB_SIZE roundup(0x9ef000, 4096)
#elif defined(CONFIG_MACH_LYNX_DZ40)
#define MSM_FB_SIZE roundup(0x9ef000, 4096)
#elif defined(CONFIG_MACH_LYNX_DL12)
#define MSM_FB_SIZE roundup(0xebd000, 4096)
#elif defined(CONFIG_MACH_DECKARD_GP4)
#define MSM_FB_SIZE roundup(0xbb8000, 4096)
#elif defined(CONFIG_MACH_DECKARD_AS70) || defined(CONFIG_MACH_TOR)
#define MSM_FB_SIZE roundup(0xac8000, 4096)
#elif defined(CONFIG_MACH_MNB)
#define MSM_FB_SIZE roundup(0x4b3000, 4096)
#else
...
#ifdef CONFIG_SHLCDC_BOARD
#define MIPI_VIDEO_SHARP_PHARAOH_HD_PANEL_NAME	"mipi_video_sharp_pharaoh_hd"
#define MIPI_VIDEO_SHARP_NICOLE_QHD_PANEL_NAME	"mipi_video_sharp_nicole_qhd"
#define MIPI_CMD_SHARP_KITE_HD_PANEL_NAME	"mipi_cmd_sharp_kite_hd"
#define MIPI_VIDEO_SHARP_TAKT_QHD_PANEL_NAME	"mipi_video_sharp_takt_qhd"
#define MIPI_CMD_SHARP_RYOMA_WXGA_PANEL_NAME	"mipi_cmd_sharp_ryoma_wxga"
#define MIPI_VIDEO_SHARP_FLUTE_FWVGA_PANEL_NAME	"mipi_video_sharp_flute_fwvga"
#define MIPI_CMD_SHARP_FLUTE_FWVGA_PANEL_NAME	"mipi_cmd_sharp_flute_fwvga"
#endif /* CONFIG_SHLCDC_BOARD */
...
static struct msm_bus_vectors mdp_720p_vectors[] = {
	/* 720p and less video */
	{
		...
		.dst = MSM_BUS_SLAVE_EBI_CH0,
#ifdef CONFIG_SHLCDC_BOARD
		.ab = ( (PANEL_WIDTH * PANEL_HEIGHT * 4 * 60) + (1280 * 720 * 1.5 * 60) ) * 2,
		.ib = ( (PANEL_WIDTH * PANEL_HEIGHT * 4 * 60) + (1280 * 720 * 1.5 * 60) ) * 1.25 * 2,
#else
		.ab = 230400000 * 2,
		.ib = 288000000 * 2,
#endif
...
static struct msm_bus_vectors mdp_1080p_vectors[] = {
	/* 1080p and less video */
	{
		...
		.dst = MSM_BUS_SLAVE_EBI_CH0,
#ifdef CONFIG_SHLCDC_BOARD
		.ab = ( (PANEL_WIDTH * PANEL_HEIGHT * 4 * 60) + (1920 * 1080 * 1.5 * 60) ) * 2,
		.ib = ( (PANEL_WIDTH * PANEL_HEIGHT * 4 * 60) + (1920 * 1080 * 1.5 * 60) ) * 1.25 * 2,
#else
		.ab = 334080000 * 2,
		.ib = 417600000 * 2,
#endif
...
static struct msm_bus_vectors mdp_extra_vectors[] = {
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab = 1067000000,
...
#ifdef CONFIG_SHLCDC_BOARD
#if defined(CONFIG_MACH_DECKARD_AS70) || defined(CONFIG_MACH_LYNX_DL10) || defined(CONFIG_MACH_BLT)
