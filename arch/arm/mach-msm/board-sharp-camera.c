...
static struct msm_camera_sensor_flash_src msm_flash_src = {
	...
	._fsrc.pmic_src.led_src_1 = PM8XXX_ID_LED_1,
	._fsrc.pmic_src.led_src_2 = 0,
	._fsrc.pmic_src.pmic_set_current = s5k3l1yx_pmic_set_flash_led_current,
};
#else
static struct msm_camera_sensor_flash_src msm_flash_src = {
...
#if defined(CONFIG_IMX091) || defined(CONFIG_S5K3L1YX) || defined(CONFIG_IMX111)
...
#ifdef CONFIG_BH6455GUL_ACT
static struct i2c_board_info bh6455gul_actuator_i2c_info = {
	I2C_BOARD_INFO("bh6455gul_act", 0x18),
};

static struct msm_actuator_info bh6455gul_actuator_info = {
	.board_info     = &bh6455gul_actuator_i2c_info,
...
#endif
static struct i2c_board_info s5k3l1yx_eeprom_i2c_info = {
	I2C_BOARD_INFO("s5k3l1yx_eeprom", 0x21),
};

static struct msm_eeprom_info s5k3l1yx_eeprom_info = {
	.board_info     = &s5k3l1yx_eeprom_i2c_info,
	.bus_id         = MSM_8960_GSBI4_QUP_I2C_BUS_ID,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3l1yx_data = {
	...
	.sensor_type          = BAYER_SENSOR,
#ifdef CONFIG_BH6455GUL_ACT
	.actuator_info = &bh6455gul_actuator_info,
#else
	.actuator_info    = &msm_act_main_cam_2_info,
#endif
	.eeprom_info = &s5k3l1yx_eeprom_info,
