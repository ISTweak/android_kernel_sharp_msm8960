...
static struct clk_freq_tbl clk_tbl_gsbi_qup[] = {
	...
	F_GSBI_QUP(  400000, pll8, 4, 1,240),
	F_GSBI_QUP(  600000, pll8, 4, 1,160),
	F_GSBI_QUP(  800000, pll8, 4, 1,120),
...
static struct clk_freq_tbl clk_tbl_cam[] = {
	...
	F_CAM( 27000000, pxo, 1, 0, 0),
#endif /* defined(CONFIG_WEBCAM_OV7692) */
...
static struct clk_lookup msm_clocks_8960[] = {
...
#ifdef	CONFIG_SHIRDA
	CLK_LOOKUP("core_clk",		gsbi10_uart_clk.c,	"msm_serial_hs.0"),
#else
	CLK_LOOKUP("core_clk",		gsbi10_uart_clk.c,	""),
#endif
#ifdef	CONFIG_SERIAL_MSM_HSL_CONSOLE
	CLK_LOOKUP("core_clk",		gsbi11_uart_clk.c,	"msm_serial_hsl.0"),
#else
	...
	CLK_LOOKUP("core_clk",		gsbi9_qup_clk.c,	"spi_qsd.9"),
	...
	CLK_LOOKUP("iface_clk",		gsbi9_p_clk.c,  "spi_qsd.9"),
#else
	CLK_LOOKUP("iface_clk",		gsbi8_p_clk.c,	"msm_serial_hsl.1"),
	CLK_LOOKUP("iface_clk",		gsbi9_p_clk.c,  "msm_serial_hs.1"),
#endif
#ifdef	CONFIG_SHIRDA
	CLK_LOOKUP("iface_clk",		gsbi10_p_clk.c,  "msm_serial_hs.0"),
#endif
	CLK_LOOKUP("iface_clk",		gsbi10_p_clk.c,		"qup_i2c.10"),
#ifdef	CONFIG_SERIAL_MSM_HSL_CONSOLE
	CLK_LOOKUP("iface_clk",		gsbi11_p_clk.c,		"msm_serial_hsl.0"),
#else
	...
	CLK_LOOKUP("csi_src_clk",	csi1_src_clk.c,		"msm_csid.1"),
#if defined(CONFIG_S5K3L1YX)
	CLK_LOOKUP("csi_src_clk",	csi0_src_clk.c,		"4-0020"),
#endif /* defined(CONFIG_S5K3L1YX) */
#if defined(CONFIG_WEBCAM_OV7692)
	CLK_LOOKUP("csi_src_clk",	csi1_src_clk.c,		"4-0078"),
#endif /* defined(CONFIG_WEBCAM_OV7692) */
	CLK_LOOKUP("csi_src_clk",	csi2_src_clk.c,		"msm_csid.2"),
	CLK_LOOKUP("csi_clk",		csi0_clk.c,		"msm_csid.0"),
	CLK_LOOKUP("csi_clk",		csi1_clk.c,		"msm_csid.1"),
#if defined(CONFIG_S5K3L1YX)
	CLK_LOOKUP("csi_clk",		csi0_clk.c,		"4-0020"),
#endif /* defined(CONFIG_S5K3L1YX) */
#if defined(CONFIG_WEBCAM_OV7692)
	CLK_LOOKUP("csi_clk",		csi1_clk.c,		"4-0078"),
#endif /* defined(CONFIG_WEBCAM_OV7692) */
	CLK_LOOKUP("csi_clk",		csi2_clk.c,		"msm_csid.2"),
	CLK_LOOKUP("csi_phy_clk",	csi0_phy_clk.c,		"msm_csid.0"),
	CLK_LOOKUP("csi_phy_clk",	csi1_phy_clk.c,		"msm_csid.1"),
#if defined(CONFIG_S5K3L1YX)
	CLK_LOOKUP("csi_phy_clk",	csi0_phy_clk.c,		"4-0020"),
#endif /* defined(CONFIG_S5K3L1YX) */
#if defined(CONFIG_WEBCAM_OV7692)
	CLK_LOOKUP("csi_phy_clk",	csi1_phy_clk.c,		"4-0078"),
#endif /* defined(CONFIG_WEBCAM_OV7692) */
	CLK_LOOKUP("csi_phy_clk",	csi2_phy_clk.c,		"msm_csid.2"),
	CLK_LOOKUP("csi_pix_clk",	csi_pix_clk.c,		"msm_ispif.0"),
	CLK_LOOKUP("csi_rdi_clk",	csi_rdi_clk.c,		"msm_ispif.0"),
