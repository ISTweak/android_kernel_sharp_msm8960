...
static const struct pm8xxx_adc_map_pt adcmap_batt_therm_custom_1[] = {
	{1800,	-41},
	{1674,	-20},
	{1582,	-10},
	{1444,	  0},
...
static const struct pm8xxx_adc_map_pt adcmap_batt_therm_custom_2[] = {
	{1800,	-40},
	{1615,	-20},
	{1514,	-10},
	{1389,	  0},
...
static const struct pm8xxx_adc_map_pt adcmap_cam_temp[] = {
	{1800,	-45},
	{1686,	-20},
	{1614,	-10},
	{1507,	  0},
...
static void pm8xxx_adc_scale_get_batt_therm_table( const struct pm8xxx_adc_map_pt **ptr_table, int *ptr_table_size )
{
...
#if defined(CONFIG_PM_BATT_THERM_TYPE2)
	switch (hw_rev)
	{
	case 0:
	case 5:
...
#if defined(CONFIG_PM_BATT_THERM_TYPE3)
	switch (hw_rev)
	{
	case 0:
	case 5:
...
#if defined(CONFIG_PM_BATT_THERM_TYPE4)
	switch (hw_rev)
	{
	case 0:
	case 4:
	...
	if (table_type == 1)
	{
		*ptr_table = adcmap_batt_therm_custom_1;
		*ptr_table_size = ARRAY_SIZE(adcmap_batt_therm_custom_1);
	}
	else
	if (table_type == 2)
	{
		*ptr_table = adcmap_batt_therm_custom_2;
		*ptr_table_size = ARRAY_SIZE(adcmap_batt_therm_custom_2);
	}
	else
	{
		*ptr_table = adcmap_batt_therm;
		*ptr_table_size = ARRAY_SIZE(adcmap_batt_therm);
	}
}
...
#if defined(CONFIG_PM_PA_THERM_TYPE1)
	switch (hw_rev)
	{
	case 0:
	case 4:
...
#if defined(CONFIG_PM_PA_THERM_TYPE2)
	switch (hw_rev)
	{
	case 0:
	case 5:
...
#if defined(CONFIG_PM_PA_THERM_TYPE3)
	switch (hw_rev)
	{
	case 0:
	case 5:
