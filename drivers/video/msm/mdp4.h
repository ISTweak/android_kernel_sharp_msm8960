...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00007 */ /* CUST_ID_00008 */ /* CUST_ID_00009 */ /* CUST_ID_00010 */ /* CUST_ID_00011 */ /* CUST_ID_00012 */ /* CUST_ID_00013 */ /* CUST_ID_00022 */ /* CUST_ID_00029 */ /* CUST_ID_00044 */
extern int vg_dither_set_flg;
extern int vg_hist_lut_set_flg;
extern int vg_qseed_set_flg;
extern int vg_csc_set_flg;
extern struct msmfb_pipe_hist_lut_data pipe_hist_lut_data;
extern struct msmfb_pipe_qseed_data pipe_qseed_data;
extern struct msmfb_dma_convert_data dma_convert_data;
extern int convert_enable;
extern int convert_set_flag;
extern struct msmfb_dma_pcc_data dma_pcc_data;
extern int pcc_enable;
extern int pcc_set_flag;
extern struct msmfb_dma_argc_lut_data dma_argc_data;
extern int argc_enable;
extern struct msmfb_dma_argc_lut_read_data dma_argc_read_data;
extern struct shdisp_boot_context shdisp_boot_ctx;
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00144 */
int mdp4_dtv_hdmi_is_open(void);
void mdp4_dtv_wait_flush(void);
#endif /* CONFIG_SHLCDC_BOARD */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00007 */ /* CUST_ID_00008 */ /* CUST_ID_00010 */ /* CUST_ID_00011 */ /* CUST_ID_00012 */ /* CUST_ID_00013 */ /* CUST_ID_00022 */ /* CUST_ID_00029 */ /* CUST_ID_00044 */ /* CUST_ID_00083 */
int mdp4_vg_dither_setup(int vp_num);
int mdp4_vg_dither_disable(int vp_num);

int mdp4_vg_hist_lut_setup(int vp_num);
int mdp4_vg_hist_lut_update(struct msmfb_pipe_hist_lut_data *p);
void mdp4_vg_hist_lut_disable(int vp_num);

void mdp4_vg_qseed_setup(void);
int mdp4_vg_qseed_update(struct msmfb_pipe_qseed_data *p);
void mdp4_vg_qseed_update_init(void);
void mdp4_vg_qseed_calc_data(struct mdp4_overlay_pipe *pipe);

void mdp4_dma_picture_adjust_setup(void);
void mdp4_dma_picture_adjust_setup_command_mode(void);

void mdp4_dma_convert_setup(void);
void mdp4_dma_convert_setup_cmd_mode(void);
int mdp4_dma_convert_update(struct msmfb_dma_convert_data *p);

void mdp4_dma_pcc_setup(void);
void mdp4_dma_pcc_setup_cmd_mode(void);
int mdp4_dma_pcc_update(struct msmfb_dma_pcc_data *p);

void mdp4_dma_argc_lut_setup(void);
int mdp4_dma_argc_lut_update(struct msmfb_dma_argc_lut_data *p);
int mdp4_dma_argc_lut_get(struct msmfb_dma_argc_lut_read_data *p);
int mdp4_dma_argc_lut_read_diagarea(void);
#endif	/* CONFIG_SHLCDC_BOARD */
