...
static char mipi_sharp_cmd_gamma_a[25] = {0xC7, 
    0x00,0x0C,0x15,0x1F,0x2E,0x42,0x2E,0x3B,0x46,0x51,0x5F,0x6D,
    0x00,0x0C,0x15,0x1F,0x2E,0x42,0x2E,0x3B,0x46,0x51,0x5F,0x6D};
static char mipi_sharp_cmd_gamma_b[25] = {0xC8, 
    0x12,0x18,0x1E,0x24,0x30,0x43,0x2F,0x3A,0x45,0x51,0x5F,0x6D,
    0x12,0x18,0x1E,0x24,0x30,0x43,0x2F,0x3A,0x45,0x51,0x5F,0x6D};
static char mipi_sharp_cmd_gamma_c[25] = {0xC9, 
    0x12,0x18,0x1E,0x24,0x30,0x44,0x30,0x3B,0x47,0x53,0x60,0x6D,
    0x12,0x18,0x1E,0x24,0x30,0x44,0x30,0x3B,0x47,0x53,0x60,0x6D};
#elif defined(CONFIG_MACH_TOR)
static char mipi_sharp_cmd_gamma_a[25] = {0xC7, 
...
#if !defined(CONFIG_MACH_TOR) && !defined(CONFIG_MACH_DECKARD_AS70)
...
#if defined(CONFIG_SHDISP_USE_CABC) && !defined(CONFIG_MACH_TOR) && !defined(CONFIG_MACH_DECKARD_AS70)
static int mipi_sharp_cabc_lcd_backlight_on(void)
{
	int rc;
