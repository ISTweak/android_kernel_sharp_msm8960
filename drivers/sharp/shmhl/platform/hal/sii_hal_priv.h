...
#ifdef CONFIG_SII8334_MHL_TX
	#define W_INT_GPIO			43							/* MHL_INT_N */		/* transmitter interrupt */
/*	#define W_INT_GPIO_OLD		99	*/						/* MHL_INT_N */		/* transmitter interrupt */
	#define W_RST_GPIO			PM8921_GPIO_PM_TO_SYS(23)	/* MHL_RST_N */		/* transmitter reset */
#else /* Original */
