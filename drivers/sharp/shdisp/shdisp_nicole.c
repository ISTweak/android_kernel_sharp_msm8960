...
#define SHDISP_NICOLE_ALPHA_DEFAULT         0x009B
...
static int shdisp_nicole_API_disp_init_2nd(void)
{
    unsigned short revision = shdisp_api_get_hw_revision();
    ...
    if(revision == SHDISP_HW_REV_PP1) {
        ...
        nicole_wdata[0]  = SHDISP_NICOLE_GAMRP0_SUBPIX;
        nicole_wdata[1]  = SHDISP_NICOLE_GAMRP1_SUBPIX;
        nicole_wdata[2]  = SHDISP_NICOLE_GAMRP2_SUBPIX;
        nicole_wdata[3]  = SHDISP_NICOLE_GAMRP3_SUBPIX;
        nicole_wdata[4]  = SHDISP_NICOLE_GAMRP4_SUBPIX;
        nicole_wdata[5]  = SHDISP_NICOLE_GAMRP5_SUBPIX;
        nicole_wdata[6]  = SHDISP_NICOLE_GAMRP6_SUBPIX;
        nicole_wdata[7]  = SHDISP_NICOLE_GAMRP7_SUBPIX;
    }
    ...
    if(revision == SHDISP_HW_REV_PP1) {
        ...
        nicole_wdata[0]  = SHDISP_NICOLE_GAMRN0_SUBPIX;
        nicole_wdata[1]  = SHDISP_NICOLE_GAMRN1_SUBPIX;
        nicole_wdata[2]  = SHDISP_NICOLE_GAMRN2_SUBPIX;
        nicole_wdata[3]  = SHDISP_NICOLE_GAMRN3_SUBPIX;
        nicole_wdata[4]  = SHDISP_NICOLE_GAMRN4_SUBPIX;
        nicole_wdata[5]  = SHDISP_NICOLE_GAMRN5_SUBPIX;
        nicole_wdata[6]  = SHDISP_NICOLE_GAMRN6_SUBPIX;
        nicole_wdata[7]  = SHDISP_NICOLE_GAMRN7_SUBPIX;
    }
    ...
    nicole_wdata[0]  = 0x01;
    nicole_wdata[1]  = 0x01;
    if(shdisp_api_get_flicker_sw() == 0) {
...
#if 1
    nicole_wdata[0]  = SHDISP_NICOLE_TVBP_VAL;
#else
    nicole_wdata[0]  = 0x03;
#endif
    ...
    nicole_wdata[0]  = SHDISP_NICOLE_PNLCTL7;
    shdisp_nicole_IO_write_reg(NICOLE_REG_PANELCTL7, nicole_wdata, 1);
...
static int shdisp_nicole_API_power_off(void)
{
    ...
    if (shdisp_api_get_shutdown_mode()) {
        shdisp_bdic_API_LCD_set_hw_reset();
    }
