...
#elif defined(CONFIG_MACH_LYNX_DL15)
            shdisp_bdic_PD_REG_OPT_temp_set(0x60);
#else
...
#ifdef CONFIG_MACH_LYNX_DL10
            shdisp_bdic_IO_write_reg(BDIC_REG_ADOH, 0x01);
#elif defined(CONFIG_MACH_LYNX_DL12)
...
#elif defined(CONFIG_MACH_LYNX_DL15)
            shdisp_bdic_PD_REG_OPT_temp_set(0x5C);
#else
...
void shdisp_bdic_API_IRQ_save_fac(void)
{
    ...
    if( shdisp_bdic_irq_fac & SHDISP_BDIC_INT_GFAC_DET ){
        mipi_sharp_stat_inc(SHDISP_STAT_INC_ERR_DET);
...
int shdisp_bdic_API_PHOTO_lux_timer( int onoff )
{
    ...
    if( onoff == SHDISP_BDIC_PHOTO_LUX_TIMER_OFF ){
        ...
        shdisp_bdic_IO_set_bit_reg(BDIC_REG_ALS_DATA0_SET, SHDISP_BDIC_I2C_ADO_UPDATE_MASK);
        shdisp_SYS_delay_us(1000);
#if defined(CONFIG_MACH_TOR) || defined(CONFIG_MACH_MNB) || defined(CONFIG_MACH_LYNX_DL10) || defined(CONFIG_MACH_LYNX_DL12) || defined(CONFIG_MACH_LYNX_DL15)
...
#if defined(CONFIG_MACH_TOR) || defined(CONFIG_MACH_MNB) || defined(CONFIG_MACH_LYNX_DL10) || defined(CONFIG_MACH_LYNX_DL15)
    if(s_state_str.bdic_main_bkl_opt_mode_ado == SHDISP_BDIC_MAIN_BKL_OPT_LOW){
        shdisp_bdic_IO_write_reg(BDIC_REG_TEST0, 0x04);
    }
#elif defined(CONFIG_MACH_LYNX_DL12)
    if(s_state_str.bdic_main_bkl_opt_mode_ado == SHDISP_BDIC_MAIN_BKL_OPT_LOW){
        shdisp_bdic_IO_write_reg(BDIC_REG_TEST0, 0x02);
    }
#endif
    return ret;
}
...
static void shdisp_bdic_PD_BDIC_init(void)
{
    ...
    shdisp_bdic_IO_write_reg(BDIC_REG_ADO_SYS,                                  0x05);
        ...
        shdisp_bdic_IO_write_reg(BDIC_REG_ADO_SYS,                              0x04);
    }
    ...
    shdisp_bdic_IO_write_reg(BDIC_REG_GPIMSK1,                                  0x21);
