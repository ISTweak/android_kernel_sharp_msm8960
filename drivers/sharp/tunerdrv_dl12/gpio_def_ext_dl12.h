...
#define GPIO_DTVCRDDET_PORTID	8
...
#define VALID_GPIO_DTVEN		GPIO_INVALID
#define VALID_GPIO_DTVRST		GPIO_VALID
#define VALID_GPIO_DTVLNAEN		GPIO_INVALID
#define VALID_GPIO_DTVANTSW		GPIO_VALID
#define VALID_GPIO_DTVMANTSL	GPIO_VALID
#define VALID_GPIO_DTVUANTSL	GPIO_VALID
#define VALID_GPIO_DTVCANTSL	GPIO_VALID
#define VALID_GPIO_DTVCRDDET	GPIO_VALID
