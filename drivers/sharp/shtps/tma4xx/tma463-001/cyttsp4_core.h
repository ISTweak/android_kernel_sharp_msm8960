...
/*
 * use the following define to allow auto sensor calibration on startup
#define STARTUP_CALIBRATION
 */

/*
 * use the following define to allow auto sensor calibration after firmware update
 */
...
/*
 * use the following define to allow calibration on adjustment
 */
#define CALIBRATION_ON_ADJUSTMENT
...
/*
 * use the following define to delay charger armor off
#define DELAY_CHARGER_ARMOR_OFF
 */

/*
 * use the following define to enable jitter filter
 */
#define ENABLE_JITTER_FILTER

/*
 * use the following define to enable functions for diag mode
 */
#define SHTPSIF_COMMAND
