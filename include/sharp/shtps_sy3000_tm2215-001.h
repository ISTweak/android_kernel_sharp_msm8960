 ...
 *
 */
#ifndef __SHTPS_SY3000_TM2215_001_H__
#define __SHTPS_SY3000_TM2215_001_H__
...
#define TPSDEV_SET_THINOUT_EVMODE		_IOW ( TPS_IOC_MAGIC, 42, int)
#define TPSDEV_SET_INVALID_AREA			_IOW ( TPS_IOC_MAGIC, 43, int)
#define TPSDEV_SET_CHARGER_ARMOR			_IOW(TPS_IOC_MAGIC, 44, int)
#define TPSDEV_SET_WIRELESS_CHARGER_ARMOR	_IOW(TPS_IOC_MAGIC, 45, int)
...
/* -----------------------------------------------------------------------------------
 */
#define SHTPS_F01_RMI_CTRL_ADR	0x5c
...
#define F01_QUERY_RESET_ENABLED(data)			(data[25] & 0x01)
#define F01_QUERY_RESET_POLARITY(data)			((data[25] >> 1) & 0x01)
#define F01_QUERY_RESET_PULLUPENABLED(data)		((data[25] >> 2) & 0x01)
...
#define F34_QUERY_REGMAP(data)				(data[2] & 0x01)
#define F34_QUERY_UNLOCKED(data)			((data[2] >> 1) & 0x01)
#define F34_QUERY_HASCONFIGID(data)			((data[2] >> 2) & 0x01)
...
#define F54_QUERY_ANALOGHARDWAREFAMILY(data)			data[6]
#define F54_QUERY_HASPIXELTOUCHTHRESHOLDTUNING(data)	(data[7] & 0x01)
#define F54_QUERY_HASARBITRARYSENSORASSIGNMENT(data)	(data[8] & 0x01)
#define F54_QUERY_HASINTERFERENCEMETRIC(data)			((data[8] >> 1) & 0x01)
#define F54_QUERY_HASSENSEFREQCONTROL(data)				((data[8] >> 2) & 0x01)
#define F54_QUERY_HASFWNOISEMITIGATION(data)			((data[8] >> 3) & 0x01)
#define F54_QUERY_HASLOWPOERCTRL(data)					((data[8] >> 4) & 0x01)
#define F54_QUERY_HASTWOBYTEREPORTRATEREPORTING(data)	((data[8] >> 5) & 0x01)
#define F54_QUERY_HASONEBYTEREPORTRATEREPORTING(data)	((data[8] >> 6) & 0x01)
#define F54_QUERY_HASRELAXATIONCTRL(data)				((data[8] >> 7) & 0x01)
#define F54_QUERY_AXISCOMPENSATIONMODE(data)			(data[9] & 0x03)
#define F54_QUERY_HASIIRFILTER(data)					((data[10] >> 1) & 0x01)
#define F54_QUERY_HASCMNREMOVAL(data)					((data[10] >> 2) & 0x01)
#define F54_QUERY_HASCMNCAPSCALEFACTOR(data)			((data[10] >> 3) & 0x01)
#define F54_QUERY_HASPIXCELTHRESHHYSTERESIS(data)		((data[10] >> 4) & 0x01)
#define F54_QUERY_HASEDGECOMPENSATION(data)				((data[10] >> 5) & 0x01)
#define F54_QUERY_HASPERFREQNOISECTRL(data)				((data[10] >> 6) & 0x01)
#define F54_QUERY_HASFORCEFASTRELAXATION(data)			(data[11] & 0x01)
#define F54_QUERY_HASMMSTATEMITIGATION(data)			((data[11] >> 1) & 0x01)
#define F54_QUERY_HASCDM4(data)							((data[11] >> 2) & 0x01)
#define F54_QUERY_HASVARIANCEMETRIC(data)				((data[11] >> 3) & 0x01)
#define F54_QUERY_HAS0DRELAXATIONCTRL(data)				((data[11] >> 4) & 0x01)
#define F54_QUERY_HAS0DACQUISITIONCTRL(data)			((data[11] >> 5) & 0x01)
...
#endif /* __SHTPS_SY3000_TM2215_001_H__ */
