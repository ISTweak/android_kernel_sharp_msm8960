...
#define TPSIF_FW_IMG_SIZE       55607
#define TPSIF_TX_NUM		13
#define TPSIF_RX_NUM		22
#else
#define TPSIF_FW_IMG_SIZE       55607
#define TPSIF_TX_NUM		12
#define TPSIF_RX_NUM		21
...
#define TPSIF_SET_CHARGER_ARMOR			_IOW(TPSIF_IOC_MAGIC, 23, int)
#define TPSIF_SET_WIRELESS_CHARGER_ARMOR	_IOW(TPSIF_IOC_MAGIC, 24, int)
...
extern void msm_tps_set_chargerarmor(int nMode);
