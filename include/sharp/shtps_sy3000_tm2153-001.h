 ...
 *
 */
#ifndef __SHTPS_SY3000_TM2153_001_H__
#define __SHTPS_SY3000_TM2153_001_H__
...
/* -----------------------------------------------------------------------------------
 */
#define SHTPS_F01_RMI_CTRL_ADR	0x005C
#define SHTPS_FINGER_MAX		6
...
#define F11_DATA_XPOS(data)				(((data[1] << 0x04) & 0x0FF0) | (data[3] & 0x0F))
#define F11_DATA_YPOS(data)				(((data[2] << 0x04) & 0x0FF0) | ((data[3] >> 0x04) & 0x0F))
#define F11_DATA_WX(data)				(data[4] & 0x0F)
#define F11_DATA_WY(data)				((data[4] >> 0x04) & 0x0F)
#define F11_DATA_Z(data)				data[5]
...
#endif /* __SHTPS_SY3000_TM2153_001_H__ */
