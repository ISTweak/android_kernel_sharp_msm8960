...
/* shmds add -> */
/* - GPIO PORTS - */
#define GPIO_ACCEL_INT                67
#define GPIO_GYRO_INT                 69
#define GPIO_COMPASS_DRDY             0
#define GPIO_COMPASS_INT              0
/* <- shmds add */
...
/* shmds mod -> */
#define MPU_GET_PORTSTATE           _IOR(MPU_IOCTL, 0xF0, char[4])
#define MPU_GET_POLARITY            _IOR(MPU_IOCTL, 0xF1, signed char[3][9])
#define MPU_WRITE_REGISTER          _IOW(MPU_IOCTL, 0xF2, struct mpu_read_write)
#define MPU_READ_REGISTER           _IOWR(MPU_IOCTL, 0xF3, struct mpu_read_write)
/* <- shmds mod */

/* shmds add -> */
#if defined(SHMDS_DETECT) && defined (SHMDS_ADB_FLAG)
#define MPU_MODIFY_BUF_SIZE         _IOW(MPU_IOCTL, 0xF4, int)
#define MPU_MODIFY_THRESH           _IOW(MPU_IOCTL, 0xF5, int)
#define MPU_MODIFY_THS_VALUE        _IOW(MPU_IOCTL, 0xF6, int)
#define MPU_MODIFY_DURATION_VALUE   _IOW(MPU_IOCTL, 0xF7, int)
#define MPU_MODIFY_THRESH2          _IOW(MPU_IOCTL, 0xF8, int)
