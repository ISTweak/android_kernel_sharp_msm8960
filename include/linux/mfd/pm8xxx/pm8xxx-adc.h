...
enum pm8xxx_adc_channels {
	...
	ADC_MPP_1_CHG_AMUX6 = 66,
	ADC_MPP_1_USB_AMUX6 = 86,
#ifdef CONFIG_PM_MPP_12_USE_BACKLIGHT_THERM
	ADC_MPP_1_BACKLIGHT_AMUX6 = 106,
...
#ifdef CONFIG_BATTERY_SH
#define PM8XXX_CHANNEL_MPP_SCALE1_CHG_IDX	60
#define PM8XXX_CHANNEL_MPP_SCALE1_USB_IDX	80
#ifdef CONFIG_PM_MPP_12_USE_BACKLIGHT_THERM
#define PM8XXX_CHANNEL_MPP_SCALE1_BACKLIGHT_IDX  (100)
#endif /* CONFIG_PM_MPP_12_USE_BACKLIGHT_THERM */
#endif /* CONFIG_BATTERY_SH */
...
{ return -ENXIO; }
#ifdef CONFIG_BATTERY_SH
static inline uint32_t pm8xxx_adc_recalib_device(void)
{ return -ENXIO; }
#endif /* CONFIG_BATTERY_SH */
#endif
